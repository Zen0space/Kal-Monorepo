...
export function Sidebar({
  ...
  return (
    <div className="w-64 bg-dark-surface border-r border-dark-border flex flex-col h-full">
      {/* Header */}
      <div className="h-16 flex items-center border-b border-dark-border px-4 flex-shrink-0">
        <button
          onClick={onNewChat}
          className="w-full group flex items-center justify-center gap-2 px-4 py-2.5 bg-gradient-to-r from-accent to-accent-hover text-white rounded-xl transition-all duration-300 shadow-lg shadow-accent/20 hover:shadow-accent/40 hover:-translate-y-0.5"
        >

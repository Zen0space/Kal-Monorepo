      ...
      <Container>
        ...
        <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
          ...
          <AnimateIn direction="left" delay={0.1}>
            <div className="p-8 rounded-2xl bg-dark-surface border border-dark-border h-full">
          ...
          <AnimateIn direction="right" delay={0.2}>
            <div className="p-8 rounded-2xl bg-dark-surface border border-accent/20 h-full shadow-[inset_0_1px_0_rgba(16,185,129,0.1)]">

        ...
        >
          {sampleFoods.map((food, index) => (
            <StaggerChild key={index}>
              <div className="p-5 rounded-xl bg-dark-surface border border-dark-border hover:border-accent/30 hover:-translate-y-1 hover:shadow-lg hover:shadow-dark/50 transition-all duration-300">
